...
# Import de tous les modèles pour que SQLModel.metadata les connaisse
...
# Branchement du metadata SQLModel
target_metadata = SQLModel.metadata

# Injection de l'URL depuis les settings (surcharge alembic.ini)
